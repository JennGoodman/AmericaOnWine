...
insert into aow_inventory (id, name, brand_id, user_id, country_id, sub_type_id, volume, year, price, quantity, submitted, status, description, image_url) 
    values (aow_inventory_seq.nextVal, 'Blood Red', 3, 2, 112, 8, 2, 2017, 11.01, 2, sysdate, 2, 'An great, deep red that pairs well with anything.', 'https://s3.us-east-2.amazonaws.com/americaonwine/ci_720.jpg');
insert into aow_inventory (id, name, brand_id, user_id, country_id, sub_type_id, volume, year, price, quantity, submitted, status, description, image_url) 
    values (aow_inventory_seq.nextVal, 'Deep Red', 2, 2, 62, 7, 1.5, 2018, 13.01, 2, sysdate, 2, 'An amazing, tart red that pairs well with potatoes.', 'https://s3.us-east-2.amazonaws.com/americaonwine/ci_235.jpg');
insert into aow_inventory (id, name, brand_id, user_id, country_id, sub_type_id, volume, year, price, quantity, submitted, status, description, image_url) 
    values (aow_inventory_seq.nextVal, 'Delicious Red', 3, 2, 14, 11, .5, 2016, 16.12, 2, sysdate, 2, 'A delicious, sweet red that pairs well with potatoes.', 'https://s3.us-east-2.amazonaws.com/americaonwine/ci_910.jpg');
insert into aow_inventory (id, name, brand_id, user_id, country_id, sub_type_id, volume, year, price, quantity, submitted, status, description, image_url) 
    values (aow_inventory_seq.nextVal, 'Heady Champagne', 4, 2, 19, 27, .5, 2016, 13.52, 2, sysdate, 2, 'A great champagne for all occasions.', 'https://s3.us-east-2.amazonaws.com/americaonwine/ci_1354.jpg');
insert into aow_inventory (id, name, brand_id, user_id, country_id, sub_type_id, volume, year, price, quantity, submitted, status, description, image_url) 
    values (aow_inventory_seq.nextVal, 'Fresh Champagne', 1, 2, 130, 30, .5, 2018, 15.12, 2, sysdate, 2, 'A delicious rose champagne for all occasions.', 'https://s3.us-east-2.amazonaws.com/americaonwine/ci_1829.jpg');
insert into aow_inventory (id, name, brand_id, user_id, country_id, sub_type_id, volume, year, price, quantity, submitted, status, description, image_url) 
    values (aow_inventory_seq.nextVal, 'Rose Champagne', 5, 2, 146, 30, .5, 2018, 8.99, 2, sysdate, 2, 'A scrumptious rose champagne for all occasions.', 'https://s3.us-east-2.amazonaws.com/americaonwine/ci_2502.jpeg');
insert into aow_inventory (id, name, brand_id, user_id, country_id, sub_type_id, volume, year, price, quantity, submitted, status, description, image_url) 
    values (aow_inventory_seq.nextVal, 'Rose Wine', 6, 2, 156, 22, 1.5, 2018, 9.99, 2, sysdate, 2, 'A tart rose wine for a good time.', 'https://s3.us-east-2.amazonaws.com/americaonwine/ci_2516.jpg');
insert into aow_inventory (id, name, brand_id, user_id, country_id, sub_type_id, volume, year, price, quantity, submitted, status, description, image_url) 
    values (aow_inventory_seq.nextVal, 'Sweet Wine', 7, 2, 162, 1, 2, 2016, 19.99, 2, sysdate, 2, 'A sweet white wine, great with fish.', 'https://s3.us-east-2.amazonaws.com/americaonwine/ci_3756.jpg');
insert into aow_inventory (id, name, brand_id, user_id, country_id, sub_type_id, volume, year, price, quantity, submitted, status, description, image_url) 
    values (aow_inventory_seq.nextVal, 'Lively Wine', 8, 2, 162, 11, 2, 2016, 13.99, 2, sysdate, 2, 'A lively red wine, great with everything.', 'https://s3.us-east-2.amazonaws.com/americaonwine/ci_4217.jpg');  
insert into aow_inventory (id, name, brand_id, user_id, country_id, sub_type_id, volume, year, price, quantity, submitted, status, description, image_url) 
    values (aow_inventory_seq.nextVal, 'Vivacious', 9, 2, 42, 6, 2, 2016, 17.99, 2, sysdate, 2, 'A vivacious white wine, great for weddings.', 'https://s3.us-east-2.amazonaws.com/americaonwine/ci_4458.jpg');
insert into aow_inventory (id, name, brand_id, user_id, country_id, sub_type_id, volume, year, price, quantity, submitted, status, description, image_url) 
    values (aow_inventory_seq.nextVal, 'Old Form', 10, 2, 47, 11, 1, 2016, 12.99, 2, sysdate, 2, 'A deep red wine, great for bachelor parties.', 'https://s3.us-east-2.amazonaws.com/americaonwine/ci_5540.jpg'); 
insert into aow_inventory (id, name, brand_id, user_id, country_id, sub_type_id, volume, year, price, quantity, submitted, status, description, image_url) 
    values (aow_inventory_seq.nextVal, 'Lover wine', 11, 2, 47, 22, 1.25, 2012, 13.32, 2, sysdate, 2, 'A fresh rose wine for the ladies.', 'https://s3.us-east-2.amazonaws.com/americaonwine/ci_15296.jpg');
insert into aow_inventory (id, name, brand_id, user_id, country_id, sub_type_id, volume, year, price, quantity, submitted, status, description, image_url) 
    values (aow_inventory_seq.nextVal, 'Ad Victorium', 12, 2, 59, 29, 2.25, 2012, 33.32, 2, sysdate, 2, 'To victory!', 'https://s3.us-east-2.amazonaws.com/americaonwine/ci_16480.jpg');
insert into aow_inventory (id, name, brand_id, user_id, country_id, sub_type_id, volume, year, price, quantity, submitted, status, description, image_url) 
    values (aow_inventory_seq.nextVal, 'Girl Night!', 13, 2, 59, 21, 2, 2018, 15.32, 2, sysdate, 2, 'We will get white girl wasted!', 'https://s3.us-east-2.amazonaws.com/americaonwine/ci_20394.jpg');
insert into aow_inventory (id, name, brand_id, user_id, country_id, sub_type_id, volume, year, price, quantity, submitted, status, description, image_url) 
    values (aow_inventory_seq.nextVal, 'Somber Wine', 14, 2, 78, 9, 2, 2018, 15.32, 2, sysdate, 2, 'For justice.', 'https://s3.us-east-2.amazonaws.com/americaonwine/ci_20877.jpg');
insert into aow_inventory (id, name, brand_id, user_id, country_id, sub_type_id, volume, year, price, quantity, submitted, status, description, image_url) 
    values (aow_inventory_seq.nextVal, 'Fun Wine', 15, 2, 79, 1, 1.5, 2018, 12.47, 2, sysdate, 2, 'Ranga Ranga!', 'https://s3.us-east-2.amazonaws.com/americaonwine/ci_21587.jpg');
insert into aow_inventory (id, name, brand_id, user_id, country_id, sub_type_id, volume, year, price, quantity, submitted, status, description, image_url) 
    values (aow_inventory_seq.nextVal, 'Beach Wine', 16, 2, 84, 3, .5, 2018, 7.47, 2, sysdate, 2, 'Kick back and drink up!', 'https://s3.us-east-2.amazonaws.com/americaonwine/ci_28252.jpg');
insert into aow_inventory (id, name, brand_id, user_id, country_id, sub_type_id, volume, year, price, quantity, submitted, status, description, image_url) 
    values (aow_inventory_seq.nextVal, 'Sun Wine', 17, 2, 84, 21, .5, 2018, 8.47, 2, sysdate, 2, 'Like the South of France!', 'https://s3.us-east-2.amazonaws.com/americaonwine/ci_57577.jpg');
insert into aow_inventory (id, name, brand_id, user_id, country_id, sub_type_id, volume, year, price, quantity, submitted, status, description, image_url) 
    values (aow_inventory_seq.nextVal, 'Mountain Wine', 18, 2, 100, 15, 2.5, 2013, 17.59, 2, sysdate, 2, 'Comme le montagne.', 'https://s3.us-east-2.amazonaws.com/americaonwine/ci_58770.jpg');
insert into aow_inventory (id, name, brand_id, user_id, country_id, sub_type_id, volume, year, price, quantity, submitted, status, description, image_url) 
    values (aow_inventory_seq.nextVal, 'Starry Wine', 19, 2, 102, 14, 2, 2014, 12.23, 2, sysdate, 2, 'Comme les astres.', 'https://s3.us-east-2.amazonaws.com/americaonwine/ci_59301.jpg');
insert into aow_inventory (id, name, brand_id, user_id, country_id, sub_type_id, volume, year, price, quantity, submitted, status, description, image_url) 
    values (aow_inventory_seq.nextVal, 'Deep Champagne', 12, 2, 104, 29, 2, 1997, 42.23, 2, sysdate, 2, 'Deep.', 'https://s3.us-east-2.amazonaws.com/americaonwine/ci_60212.jpg');
insert into aow_inventory (id, name, brand_id, user_id, country_id, sub_type_id, volume, year, price, quantity, submitted, status, description, image_url) 
    values (aow_inventory_seq.nextVal, 'Light White', 8, 2, 11, 3, 2, 1997, 12.23, 2, sysdate, 2, 'Straight from Jersey!.', 'https://s3.us-east-2.amazonaws.com/americaonwine/ci_61555.jpg');
insert into aow_inventory (id, name, brand_id, user_id, country_id, sub_type_id, volume, year, price, quantity, submitted, status, description, image_url) 
    values (aow_inventory_seq.nextVal, 'Crisp Rose', 2, 2, 15, 21, 2, 1997, 16.99, 2, sysdate, 2, 'Delicious to the last drop.', 'https://s3.us-east-2.amazonaws.com/americaonwine/ci_62005.jpg');
insert into aow_inventory (id, name, brand_id, user_id, country_id, sub_type_id, volume, year, price, quantity, submitted, status, description, image_url) 
    values (aow_inventory_seq.nextVal, 'Lovely Champagne', 12, 2, 114, 29, 2, 1997, 42.23, 2, sysdate, 2, 'Deep.', 'https://s3.us-east-2.amazonaws.com/americaonwine/ci_veuve_clicquot_yellow_label_3d99da125d8c84f1.jpeg');
