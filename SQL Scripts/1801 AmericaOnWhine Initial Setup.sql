...
insert into aow_inventory (id, name, brand_id, user_id, country_id, sub_type_id, volume, year, price, quantity, submitted, description, image_url) 
    values (4, 'Max''s Brew', 3, 2, 4, 10, .5, 2018, 9.99, 12, sysdate, 'It''s good Wine Bront!', 'https://s3.us-east-2.amazonaws.com/americaonwine/wine.jpg');
insert into aow_inventory (id, name, brand_id, user_id, country_id, sub_type_id, volume, year, price, quantity, submitted, description, image_url) 
...
insert into aow_inventory (id, name, brand_id, user_id, country_id, sub_type_id, volume, year, price, quantity, submitted, description, image_url) 
    values (8, 'New Wine', 5, 2, 200, 20, 1.0, 1995, 38.29, 18, sysdate, 'It''s good Wine Bront!', 'https://s3.us-east-2.amazonaws.com/americaonwine/wine.jpg');
insert into aow_inventory (id, name, brand_id, user_id, country_id, sub_type_id, volume, year, price, quantity, submitted, description, image_url) 
    values (9, 'Robot Oil', 4, 2, 79, 27, 1.0, 1800, 10.99, 12, sysdate, 'It''s good Wine Bront!', 'https://s3.us-east-2.amazonaws.com/americaonwine/wine.jpg');
insert into aow_inventory (id, name, brand_id, user_id, country_id, sub_type_id, volume, year, price, quantity, submitted, description, image_url) 
